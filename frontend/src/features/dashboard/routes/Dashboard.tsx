    ...
    return (
        <>
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <Button
                    variant="outline"
                    className="w-full sm:w-auto flex items-center justify-center gap-2 bg-white text-sm font-medium border-slate-200 shadow-sm hover:bg-slate-50 cursor-pointer"
                >
            ...
            <div className="grid gap-4 md:grid-cols-3">
                <div className="bg-white border border-slate-200/60 p-5 rounded-xl shadow-sm flex flex-col gap-1">
                    ...
                    <span className="text-3xl font-bold tracking-tight text-slate-900 mt-1">
                        {isLoading ? '...' : stats.activeTrainings}
                    </span>
                </div>
                <div className="bg-white border border-slate-200/60 p-5 rounded-xl shadow-sm flex flex-col gap-1">
                    <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-500 mt-0.5">
                                    Improve your compliance score
                                </p>
                            </div>
                        </div>
                        <span className="text-slate-400 group-hover:text-slate-600 transition-colors text-lg font-medium pr-1">
                            ›
                        </span>
                    </div>
                    ...
                    <div className="bg-white border border-slate-200/60 p-4 rounded-xl shadow-sm flex items-center justify-between hover:border-slate-300 transition-all cursor-pointer group">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-500 mt-0.5">
                                    Get back on track to certified
                                </p>
                            </div>
                        </div>
                        <span className="text-slate-400 group-hover:text-slate-600 transition-colors text-lg font-medium pr-1">
            ...
            <div className="grid gap-6 md:grid-cols-3">
                <div className="md:col-span-2 bg-white border border-slate-200/60 rounded-xl p-5 shadow-sm flex flex-col gap-4">
                    <div className="flex items-center justify-between">
                        ...
                        <Button
                            variant="link"
                            className="text-xs text-slate-600 p-0 font-semibold h-auto cursor-pointer"
                        >
                            View all
                        </Button>
                    </div>
                        ...
                        {!isLoading &&
                            ...
                            activities.map((activity) => {
                                ...
                                return (
                                    <div
                                        key={activity.id}
                                        className="flex items-start gap-4 pb-3 border-b border-slate-100 last:border-0 last:pb-0"
                                    >
                                        <div
                                            className={`h-8 w-8 rounded-lg flex items-center justify-center shrink-0 ${styles.containerClass}`}
                                        >
                                            {styles.icon}
                                        </div>
